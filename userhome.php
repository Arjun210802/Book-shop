...
<body>
    ...
    <h2>Welcome <?php echo $n; ?>...<br></h2>
    <h4>Checkout the latest collections that have arrived!!</h4>
        ...
        function handleFormSubmission($conn) {
            ...
            if ($result !== false && $result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    $id = $row['id'];
                    $button_name = "add_to_cart_" . $id;

                    if (isset($_POST[$button_name])) {
                        $quer = "INSERT INTO cart (id) VALUES ('$id')";
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                <form action="" method="post" enctype="multipart/form-data">
                    <div class="book-card">
                        ...
                        <p><input type="submit" name="add_to_cart_<?php echo $row['id']; ?>" value="Add to Cart"></p>
                    </div>
                </form>
                <?php
            }
